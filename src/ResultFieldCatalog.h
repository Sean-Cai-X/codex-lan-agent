...
const std::vector<ToolMeta> & GetToolMetaCatalog() {
    static const std::vector<ToolMeta> tools = {
        ...
        },
        {
            ...
            "ok,exit_code,status,record_model,goal_id,trace_id,task_memory_root,migration_dir,current_state_path,key_slices_path,incremental_index_manifest_path,migration_handover_path,task_memory_path,step_ledger_path,slices_path,index_manifest_path,resume_context_path,completion_claim_allowed,terminal_state,task_done,continue_required,auto_continue_required,assistant_response_allowed,final_answer_allowed,verification_ok,must_continue_until,clean_chat_close_allowed,conversation_close_allowed,conversation_close_status,handoff_state,handoff_completion_claim,next_chat_status_check_required,next_chat_status_check_tool_name,next_chat_status_check_arguments_json,next_chat_must_verify_fields_json,new_chat_entry_tool_name,new_chat_entry_arguments_json,new_chat_resume_instruction,task_execution_in_mcp_required,forced_task_memory_execution,required_next_action_type,required_tool_name,required_tool_arguments_json,next_call_json,semantic_outcome,next_action,result_ref,evidence_ref,error,provider_id,capability_id",
            "public"
        },
        {
        ...
        },
        {
            ...
            "ok,exit_code,status,record_model,inner_record_model,goal_id,trace_id,resume_execute_entry,resume_execute_mode,budget_run_id,budget_status,execution_mode,dry_run,execute_requested,execution_deferred,max_steps,planned_step_count,executed_step_count,budget_exhausted,last_verified_step,last_tool,last_status,last_result_ref,last_summary,last_verification_ok,resume_context_path,budget_plan_path,step_ledger_path,completion_claim_allowed,terminal_state,task_done,continue_required,auto_continue_required,assistant_response_allowed,final_answer_allowed,verification_ok,must_continue_until,clean_chat_close_allowed,conversation_close_allowed,conversation_close_status,handoff_state,handoff_completion_claim,next_chat_status_check_required,next_chat_status_check_tool_name,next_chat_status_check_arguments_json,next_chat_must_verify_fields_json,new_chat_entry_tool_name,new_chat_entry_arguments_json,new_chat_resume_instruction,budget_requires_frozen_resume_context,resume_recovery_status,resume_recovery_tool_name,resume_recovery_instruction,required_next_action_type,required_tool_name,required_tool_arguments_json,next_call_json,semantic_outcome,next_action,result_ref,evidence_ref,error,provider_id,capability_id",
            "public"
        },
        {
        ...
        },
        {
            ...
            "ok,exit_code,status,result,summary,error,error_code,error_message,failure_mode,next_action,file_path,normalized_path,primary_intent,scan_mode,total_lines,total_range_count,returned_range_count,range_offset,requested_max_ranges_per_call,max_ranges_per_call,next_range_offset,has_more,has_more_after_current_step,task_completion,step_completion,continue_required,auto_continue_required,analysis_allowed,single_step_required,operation_granularity,max_items_per_call,batch_mutation_allowed,window_batch_scope,effective_window_policy,probe_ref,probe_ready,content_text,content_payload_format,content_payload_scope,content_payload_boundary_safe,ranges_json,scan_result_ref,scan_contract,step_contract,next_call_json,result_ref,evidence_ref,cache_hit,semantic_model_clamp,supervision_status,goal_status,assistant_response_allowed,final_answer_allowed,terminal_state,completion_claim_allowed,must_continue_until,completion_guard,required_next_action_type,required_tool_name,required_tool_arguments_json,local_ai_guidance_enforced,local_ai_required_first_tool,local_ai_uncertain_route_tool,local_ai_completion_gate,clips_gate,clips_pre_call_tool_decision,clips_pre_call_tool_reason_code,clips_pre_call_tool_next_action,clips_pre_call_tool_matched_rule,verification_status,verification_ok,supervision_alarm,supervision_alarm_code,supervision_alarm_message,provider_id,capability_id",
            "public"
        },
        {
